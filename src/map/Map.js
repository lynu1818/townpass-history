...
const locations = [
	{
		...
		question:
			"228和平紀念公園內有一座「228紀念碑」，其碑文記載了當時的一些事件細節。以下哪一位人物的名字沒有被記載在228紀念碑的碑文中？",
		option1: "蔣渭水",
		option2: "陳澄波",
		option3: "吳振武",
		option4: "林茂生",
	...
	},
	{
		...
		question:
			"大稻埕曾是台北市區重要的貿易中心。以下哪一種商品在19世紀末和20世紀初時期，讓大稻埕成為國際貿易的重要樞紐？",
		option1: "茶葉",
		option2: "煙草",
		option3: "醬油",
		option4: "米",
...
const Map = () => {
	...
	// 根據類別和是否已經去過來返回不同的圖標
	const getMarkerIcon = (locationId, visited) => {
		let iconUrl;
		if (locationId > 7) {
			iconUrl =
				"https://firebasestorage.googleapis.com/v0/b/townpass-history.appspot.com/o/idea.png?alt=media&token=53351974-8b39-4888-97e0-e5d24c1ced60";
		} else if (visited) {
			iconUrl =
